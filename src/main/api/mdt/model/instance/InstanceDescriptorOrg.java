 ...
 */
public interface InstanceDescriptorOrg {
	/**
	 ...
	 * 
	 * @return	{@link MDTSubmodelDescriptor}들의 리스트.
	 */
	public List<MDTSubmodelDescriptor> getSubmodelDescriptorAll();
	 ...
	 */
	public List<MDTOperationDescriptor> getOperationDescriptorAll();
	
	/**
	 * 대상 MDTInstance가 포함한 TwinComposition의 descriptor를 반환한다.
	 * 
	 * @return {@link MDTTwinCompositionDescriptor} 객체.
	 */
