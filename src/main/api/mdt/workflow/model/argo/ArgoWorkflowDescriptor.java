...
public class ArgoWorkflowDescriptor {
	...
	public ArgoWorkflowDescriptor(WorkflowDescriptor wfDesc, String mdtEndpoint, String mdtClientImageName) {
	...
	public class Spec {
		...
		public Spec(WorkflowDescriptor wfDesc, Arguments arguments, List<ArgoTemplateDescriptor> templates) {
			this.entrypoint = "dag";
