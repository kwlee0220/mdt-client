...
public class SubmodelElementPortDescriptor extends AbstractPortDescriptor {
	...
	public SubmodelElementPortDescriptor(String name, String description, String mdtId, String submodelIdShort,
		...
		super(name, description, PortType.SME);
	...
	public static SubmodelElementPortDescriptor parseStringExpr(String name, String description, String valueExpr) {
		...
		return new SubmodelElementPortDescriptor(name, description, parts[0], parts[1], parts[2]);
	}
	
	public static SubmodelElementPortDescriptor parseJson(String name, String description, ObjectNode topNode) {
		...
		return new SubmodelElementPortDescriptor(name, description, mdtId, submodelIdShort, idShortPath);
	}
	
	@Override
	public String toStringExpr() {
		return String.format("%s:%s/%s/%s", getPortType().getId(),
