...
public class SKKUSimulationTask implements MDTTask {
	...
	public static class Command extends MultiParameterTaskCommand<SKKUSimulationTask> {
...
//		}
		...
		@Override
		protected SKKUSimulationTask newTask(KeyedValueList<String,Parameter> parameters,
