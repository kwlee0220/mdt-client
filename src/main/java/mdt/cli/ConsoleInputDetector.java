 ...
 */
public class ConsoleInputDetector extends AbstractExecutionThreadService {
	private volatile List<Character> m_quitCharacters;
	private volatile Terminal m_terminal = null;
	private volatile char m_input = '\0';

	/**
	 * 주어진 종료 문자 목록을 사용하는 {@code ConsoleInputDetector}를 생성한다.
	 *
	...
	public static void main(String... args) throws Exception {
		...
		detector.startAsync().awaitRunning();
