 ...
 */
public abstract class AbstractSetCommand extends AbstractMDTCommand {
	...
	protected void run(MDTInstanceManager manager, ElementReference ref) throws Exception {
