 ...
 */
public class SubmodelEntity extends AbstractMDTSubmodelElementContainer
									implements AASModelEntity<Submodel> {
	private String m_id;
	private Reference m_semanticId;
	
	protected SubmodelEntity() { }
	protected SubmodelEntity(String id) {
		super();
