 ...
 */
public class UserDefinedSubmodelElementContainer implements AasCRUDActions {
	protected String m_idShort;
	protected String m_idShortRef;
	protected String m_category;
	protected List<SubmodelElement> m_submodelElementList = null;

	protected UserDefinedSubmodelElementContainer(String idShort, String idShortRef) {
		m_idShort = idShort;
		m_idShortRef = idShortRef;
	}
	protected UserDefinedSubmodelElementContainer() {
		this(null, null);
	}
