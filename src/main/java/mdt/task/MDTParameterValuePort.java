 ...
 */
public class MDTParameterValuePort implements Port {
	private final String m_name;
	private final PortDirection m_direction;
	private final ParameterValueReference m_ref;
	private final boolean m_valueOnly;
	
	MDTParameterValuePort(String name, PortDirection type, ParameterValueReference ref, boolean valueOnly) {
		m_direction = type;
		m_name = name;
		m_ref = ref;
	...
	public ParameterValueReference getReference() {
		return m_ref;
	}
	...
	public boolean equals(Object obj) {
		...
		MDTParameterValuePort other = (MDTParameterValuePort)obj;
